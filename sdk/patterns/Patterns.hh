// Pattern scanner from the CitizenFX project (see the notice below), as
// vendored by IV.EFLC.Rainbomizer. mingw port: the two `#ifdef _M_IX86` arch
// checks now also accept gcc's __i386__, and <cstdint>/<cstddef> are included
// explicitly (MSVC pulls them in on its own).
/*
